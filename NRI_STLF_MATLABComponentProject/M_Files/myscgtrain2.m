%%this program is doing gaussian approximation for Neural Network. for
%%evaluating ML estimation using Scaled Congugate Gradient(scg). aw1 is a
%%vector of input size, since we want to do ARD, with evidence function.
%%the value of beta never changed during this process. the number of hidden
%%neuron is fixed.

function [samples, net,gamma,logev]=myscgtrain2(x,t,nh) 
...
for k = 1:nouter
  ...
  [net, gamma,logev] = evidenceH2(net, x, t, ninner);
